...
from sampler_protocol import build_polynomial_sigmas, latent_batch_from_seeds, parse_nfe_list
...
def test_build_polynomial_sigmas_has_terminal_zero() -> None:
    sigmas = build_polynomial_sigmas(
        num_steps=5,
        sigma_min=0.002,
        sigma_max=80.0,
        device="cpu",
